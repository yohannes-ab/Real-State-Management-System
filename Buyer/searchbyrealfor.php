...
if(isset($_GET['search'])){
   ...
   $RE_ID  = $_GET['value'];
    ...
    $search_query = "SELECT * from property where Property_for = '$RE_ID' and Status='Accepted' order by 1 DESC";
...
<input type="image" src="<?php echo $final_path; ?>" width="200" height="150">
