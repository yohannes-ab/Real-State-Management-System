...
if($_POST) {
  ...
  $password =h($errors, "Please enter your name");
  ...
  if (strlen($username) == 0 || !username.match(A-z))
  ...
  $(function() {
    ...
    $("#register-form").validate({
        ...
        messages: {
            ...
            rpassword: "Please enter a valid username"
        },
...
<body>
  ...
  <form action="./" method="post" id="register-form" novalidate="novalidate">
    ...
    <div class="label">Name</div><input type="text" id="name" name="name" value="" /><br />
    ...
    <div class="label">Password</div><input type="password" id="password" name="password" /><br />
     <div class="label">rPassword</div><input type="rpassword" id="rpassword" name="rpassword" /><br />
