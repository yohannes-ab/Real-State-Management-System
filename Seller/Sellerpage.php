            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <span class="top-label label label-warning"></span>  <i class="fa fa-envelope fa-2x"> </i> </a> 
                    
                    <!-- dropdown alerts-->
                    <ul class="dropdown-menu dropdown-alerts">
                        <li class="divider"></li>
                        <li>
                            <a href="viewsellrequest.php">
                                <div>
            ...
            <div><strong> <?php echo $_SESSION["username"];?></strong></div>
                    ...
                    <div class="user-text-online">
                        ...
                        <!--end user image section-->
                            ...
                            <li> <a href="viewsellrequest.php">View Sell Request</a>
                             </li> 

                            <li>
                        <a href="houseTransfer.php"><i class="fa fa-wrench fa-fw"></i>Real Estate Transfer<span class="fa arrow"></span></a>
