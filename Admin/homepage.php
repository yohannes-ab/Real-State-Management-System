                ...
                <div class="col-lg-8">
                    <div class="panel panel-info">
                        <div class="alert alert-info">
                         <i class="fa  fa-beer fa-2x"></i><b>&nbsp;&nbsp;&nbsp; </b>Welcome to our company 
                    </div>
                        <div class="panel-body">
                            <p> Welcome To Real Estate Recommendation  System. This System is designed to provide the facility using which customer can buy or sale their properties such as Villa,Appartement, Condominium_House,and Studios as per your requirenments which is available in the wabsite to sell.</p>
                        </div>
                    </div>
                     <div class="alert alert-info">
